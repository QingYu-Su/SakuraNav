...
import { Download, FileText, Palette, X, LoaderCircle } from "lucide-react";
...
export type ExportScope = "full" | "data-only";
...
export function ExportModeDialog({
  ...
  const options: Array<{
  ...
  }> = [
    {
      ...
      icon: Palette,
      title: "全部备份",
      desc: "导出标签、卡片和外观设置（壁纸、字体、毛玻璃等），适合完整迁移",
