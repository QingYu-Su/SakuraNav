        ...
        <div className="animate-panel-rise w-full max-w-md">
          ...
          <div className="mb-8 text-center">
            <div className="mb-6 inline-flex items-center justify-center">
              ...
              >
                <CardDetailTypeIcon cardType={card.cardType} size={36} />
              </div>
            </div>
...
/** 详情页图标（复用品牌 Logo） */
function CardDetailTypeIcon({ cardType, size = 48 }: { cardType: SocialCardType; size?: number }) {
  const meta = SOCIAL_CARD_TYPE_META[cardType];
  switch (cardType) {
    case "qq":
      return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill={meta.color}>
