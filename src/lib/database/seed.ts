  ...
  if (!hasCards?.count) {
    ...
    const cards = [
      ...
      },
      {
        ...
        siteUrl: "#",
        siteDescription: null,
        socialHint: "我的GitHub主页，用于分享项目与代码",
        iconUrl: null,
        iconBgColor: "#181717",
        siteSkipOnlineCheck: 1,
        cardType: "github",
      ...
      },
      {
        ...
        siteDescription: "全球最大的代码托管与协作开发平台，支持版本控制、开源项目管理和社区交流。",
        socialHint: null,
        ...
        cardData: null,
        globalSortOrder: 4,
        siteRecommendContext: "典型使用场景包括：个人开发者托管代码仓库、团队协作开发、参与开源项目贡献、代码审查与持续集成。适合程序员、技术团队、开源爱好者等用户群体。核心功能包括Git仓库托管、Pull Request协作、Issue跟踪、Actions自动化、Pages静态网站部署等。",
      },
      {
        id: "site-1a691b50-4e8e-40f0-95da-184f29144ad4",
        name: "DeepSeek",
        siteUrl: "https://www.deepseek.com/",
        siteDescription: "先进的人工智能模型平台，提供强大的语言理解和生成能力。",
        socialHint: null,
        ...
        cardData: null,
        globalSortOrder: 5,
        siteRecommendContext: "DeepSeek 是一个专注于人工智能模型研究与应用的平台，核心功能包括文本生成、代码辅助、逻辑推理等。典型使用场景涵盖智能客服、内容创作、代码开发辅助、学术研究等。适合开发者、研究人员、内容创作者及企业用户使用，可实现高效的知识问答、文档处理与创意生成。",
      },
      {
        id: "site-6c240d02-4f8b-4890-9c43-7a72215d94d2",
        name: "哔哩哔哩 (Bilibili)",
        siteUrl: "https://www.bilibili.com/",
        siteDescription: "中国领先的年轻文化社区和视频平台，以ACG内容起家，现覆盖广泛兴趣领域。",
        socialHint: null,
        ...
        cardData: null,
        globalSortOrder: 6,
        siteRecommendContext: "典型使用场景包括观看动漫、影视、游戏、知识科普、鬼畜、音乐等各类视频，参与弹幕互动与社区讨论。适合Z世代年轻用户、ACG爱好者、内容创作者和学习者。核心功能为视频上传与分享、直播、弹幕评论系统、专栏文章、商城及游戏联运。",
      },
      {
        id: "site-5113e0a4-edde-4213-a116-99d27d1a4c79",
        name: "有道",
        siteUrl: "https://youdao.com/",
        siteDescription: "网易旗下综合性互联网服务门户，提供搜索引擎、翻译、词典、云笔记等工具。",
        socialHint: null,
        ...
        cardData: null,
        globalSortOrder: 7,
        siteRecommendContext: "有道是网易旗下的综合互联网服务品牌，以词典和翻译工具起家，现已扩展至智能搜索、云笔记（有道云笔记）、在线教育（有道精品课）及AI助手等多个领域。典型使用场景包括：学生和职场人士查词翻译、文档协作与知识管理、学术资料搜索。核心功能为语言翻译、全文搜索、笔记同步与AI写作辅助，适合需要一站式工作学习工具的人群。",
      },
      {
